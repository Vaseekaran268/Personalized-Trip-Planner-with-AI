...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="m12 3-1.9 3.9-3.9 1.9 3.9 1.9 1.9 3.9 1.9-3.9 3.9-1.9-3.9-1.9Z"/><path d="M5 12s2.5-1 4-3"/><path d="M19 12s-2.5-1-4-3"/><path d="m12 21 1.9-3.9 3.9-1.9-3.9-1.9-1.9-3.9-1.9 3.9-3.9 1.9 3.9 1.9Z"/></svg>
);

export const WandSparklesIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m22 2-7 20-4-4-7 7-2-2 7-7-4-4L2 22"/>
    <path d="M16 16.5 19.5 13"/>
    <path d="m21.5 14.5-3-3"/>
    <path d="M4.5 2.5 8 6"/>
    <path d="m2.5 4.5 3 3"/>
  </svg>
);
...
export const TicketIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M13 5.4a2 2 0 0 0-2 0"/>
    <path d="M13 18.6a2 2 0 0 0-2 0"/>
  </svg>
);
...
export const RupeeIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M15 8.5a4 4 0 1 0-8 0" />
        <path d="M6.5 14H8m8.5 0h-2.25A4.75 4.75 0 0 0 10 9.25V8.5" />
    </svg>
);
...
export const CarIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M14 16H9m10 0h1a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-1m-4 0H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h1m11-10V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v2"></path>
